...
class Bag(models.Model):
    ...
    image = models.ImageField(upload_to='bag_images', null=True, blank=True, default='bag_images/default.jpg')
...
class BasketItem(models.Model):
    ...
    product_object = models.ForeignKey(Bag, on_delete=models.CASCADE)
...
# custom method in model
    @property #brackets is not needed(property decorator used to avoid brackets)
    def total_amount(self): #self is a basket item object
